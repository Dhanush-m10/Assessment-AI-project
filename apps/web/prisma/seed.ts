...
const areas: { id: string; categoryId: string; name: string; classification: "GENERAL" | "ROLE_BASED"; status: PublishStatus }[] = [
...
const jobTitles: { id: string; areaOfInterestId: string; name: string; assessmentFlow: AssessmentFlow; status: PublishStatus }[] = [
...
const skillId = (name: string) => `sk_${slug(name)}`;

const jobTitleSkills: Record<string, string[]> = {
...
const bandLabel: Record<ExperienceBand, string> = {
  Y0_2: "0-2 Years",
  Y2_5: "2-5 Years",
  Y5_8: "5-8 Years",
};

const jds: { id: string; jobTitleId: string; band: ExperienceBand; content: string; source: JdLibrarySource; status: PublishStatus; skills: string[] }[] = [
